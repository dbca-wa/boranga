...
--   python scripts/strip_sql_comments.py docs/sql-scripts/FaunaOCCSites.sql
-- Or write the result to a file for easy copying:
--   python scripts/strip_sql_comments.py docs/sql-scripts/FaunaOCCSites.sql > tmp.sql
-- =============================================================================
