        ...
        >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <template v-if="!isReadOnly">
                        <template
                            v-if="
                                ...
                                occurrence_report_obj.location.district_id &&
                                !filtered_district_list
                                    .map((d) => d.id)
                                    .includes(
                        ...
                        >
                            <input
                                ...
                                :value="
                                    occurrence_report_obj.location.district +
                                    ' (Now Archived)'
                                "
                                disabled
                            />
                    ...
                    <template v-else>
                        <input
                            v-model="occurrence_report_obj.location.district"
                            class="form-control"
                            type="text"
                            :disabled="isReadOnly"
                        />
...
export default {
    ...
    methods: {
        ...
        updateLocationDetails: function () {
            ...
            fetch(
                ...
                async (response) => {
                    ...
                    vm.occurrence_report_obj.location = data;
        ...
        fetchDiscardedGeometries: async function () {
            ...
            try {
                const response = await fetch(
                    api_endpoints.ocr_discarded_geometry(
        ...
        reinstateGeometry: async function (geometryId) {
            ...
            try {
                const response = await fetch(
                    api_endpoints.ocr_reinstate_geometry(
                        vm.occurrence_report_obj.id
                    ),
                    {
                        method: 'POST',
